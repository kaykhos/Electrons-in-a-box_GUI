...
Beta = 1e3; % include a damping term to take energy out of the system to converge to a steady state system first. 
Box1 = [-1,1,-1,1,-1,1]/2*1e-0; % dimentions of the box one bounding the particles, same set up as 'axis'
...
figure(123);shg
tic
KE = zeros(1,Steps); % Set initial KE vector to 
for jj = 1:Steps
